...
type MultiSelectorProps = {
  values: productProps[];
  onValuesChange: (value: productProps[]) => void;
  loop?: boolean;
} & React.ComponentPropsWithoutRef<typeof CommandPrimitive>;

interface MultiSelectContextProps {
  value: productProps[];
  onValueChange: (value: productProps) => void;
  open: boolean;
...
const MultiSelectorItem = forwardRef<
  ...
  { value: productProps} & Omit<React.ComponentPropsWithoutRef<typeof CommandPrimitive.Item>, 'value'>
>(({ className, value , children, ...props }, ref) => {
  const { value: Options, onValueChange, setInputValue } = useMultiSelect();
  const isIncluded: boolean = JSON.stringify(Options).includes(JSON.stringify(value));
